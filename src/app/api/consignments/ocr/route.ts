...
export async function POST(request: NextRequest) {
  try {
    ...
    const prompt = `Analiza esta factura de consignación/proveedor y extrae TODOS los productos listados.
${contextSection}
INSTRUCCIONES:
1. PROVEEDOR: Nombre del proveedor/consignador que emite la factura
...
- Esta es una factura de CONSIGNACIÓN, el proveedor entrega productos que se pagan después de venderse
