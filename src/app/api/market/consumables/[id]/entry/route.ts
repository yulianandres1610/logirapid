...
/**
 * POST /api/market/consumables/[id]/entry
 * Register stock entry (purchase). Uses transaction to update stock atomically.
 */
export async function POST(
  ...
  try {
    ...
    const { quantity, unitCost, supplierName, invoiceRef, notes } = body
    ...
    const result = await db.transaction(async (client) => {
      ...
      await client.query(`
        INSERT INTO market_consumable_movements (
          ...
          unit_cost, supplier_name, invoice_ref,
      ...
      `, [
        ...
        unitCost || null, supplierName || null, invoiceRef || null,
      ...
      return { stockBefore: currentStock, stockAfter: newStock }
    })
    ...
    console.error('[Consumables Entry] Error:', err)
    ...
    return NextResponse.json({
      success: false,
      error: err.message || 'Error al registrar entrada de stock'
    }, { status: 500 })
  }
}
