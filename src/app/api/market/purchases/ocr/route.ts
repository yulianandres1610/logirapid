...
export async function POST(request: NextRequest) {
  try {
    ...
    const prompt = `Analiza esta factura de proveedor y extrae CADA LÍNEA de producto por separado.
${contextSection}
INSTRUCCIONES:
1. PROVEEDOR: Nombre del negocio o empresa que emite la factura
