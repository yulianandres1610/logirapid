...
export async function POST(request: NextRequest) {
  try {
    ...
    const prompt = `Eres un experto en OCR de facturas de proveedores. Analiza este documento y extrae TODOS los productos/items de forma precisa.
${contextSection}
...
1. PROVEEDOR: Nombre completo del proveedor/distribuidor/vendedor que emite la factura
2. NÚMERO DE FACTURA: Número, código o referencia de la factura (ej: FAC-001, INV-2025-001, #12345, NCF)
3. FECHA: Fecha de la factura en formato YYYY-MM-DD (busca "Fecha:", "Date:", día/mes/año)
...
- quantity: Cantidad numérica (puede ser decimal como 1.5, 0.5)
- unit: Unidad de medida si aparece (UND, CAJA, KG, LB, LT, PAQ, DOC, null si no está)
- unitCost: Precio unitario de costo (el que pagamos al proveedor)
...

{
  "invoices": [
    {
      "vendorName": "Nombre del Proveedor S.A.",
...
RESPONDE ÚNICAMENTE CON EL JSON, sin texto adicional, sin markdown, sin explicaciones.`
    ...
    try {
      ...
      console.log('[Purchase OCR] Processed:', {
