...
export default function BrokerLoginPage() {
  ...
  const onSubmit = async (data: BrokerLoginFormData) => {
    setError(null)
    setIsLoading(true)
    setShowLoadingOverlay(true)
              ...
              <AnimatePresence>
                {error && (
                  <motion.div
                    ...
                    className="flex items-center space-x-2 p-3 sm:p-4 bg-red-500/10 border border-red-500/20 rounded-2xl"
                  >
