...
export default function SupplierLoginPage() {
  ...
  // Check if supplier is already authenticated on mount
  useEffect(() => {
    ...
    const checkAuthentication = () => {
      ...
      if (supplierToken) {
        console.log('[SUPPLIER LOGIN] Supplier already authenticated, redirecting to dashboard')
              ...
              onError={(e) => {
                ...
                if (parent) {
                  parent.innerHTML = `
                    ...
                    <p class="text-exa-secondary text-sm mt-2">Portal de Proveedores</p>
                  `;
                }
              }}
            />
            <p className="text-exa-secondary text-sm mt-2 font-medium">Portal de Proveedores</p>
          </motion.div>
              ...
              >
                <div className="relative">
                  ...
                  <input
                    ...
                    {...register('username')}
                    className={`
                      w-full pl-12 pr-4 py-4 bg-white/5 border ${errors.username ? 'border-red-500' : 'border-exa-secondary/30'}
                      ...
                      ${watchedUsername ? 'bg-white/10 border-exa-secondary/50' : ''}
                    `}
                    disabled={isLoading}
                  />
                </div>
