        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
              Gestiona los servicios de impresión locales instalados
            </p>
          </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
              Crea un servicio y descarga la aplicación de impresión para comenzar
            </p>
              ...
              >
                ...
                <div className="flex gap-2 pt-3 border-t border-gray-100 dark:border-gray-700">
                  <Button
                    ...
                    size="sm"
                    className="flex-1"
                    onClick={() => router.push(`/dashboard/admin/print-services/${service.id}`)}
                  >
                  ...
                  <Button
                    ...
                    size="sm"
                    className="flex-1"
                    onClick={() => router.push(`/dashboard/admin/print-services/${service.id}/config`)}
                  >
