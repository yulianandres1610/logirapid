...
export default function AdminDashboard() {
  ...
  // Simplified stats - only the most important ones
  const stats = [
    {
      title: "Usuarios",
      value: "1,234",
    ...
    },
    {
      ...
      icon: Building2,
      description: "Verificadas"
    }
  ]

  const recentActivity = [
    { id: 1, user: "María García", action: "Nueva empresa registrada", time: "hace 5 min", type: "success" },
    { id: 2, user: "Carlos Rodríguez", action: "Transacción completada", time: "hace 12 min", type: "success" },
    { id: 3, user: "Ana Martínez", action: "Perfil actualizado", time: "hace 25 min", type: "info" },
    { id: 4, user: "Luis Hernández", action: "Recarga móvil", time: "hace 1 hora", type: "warning" }
  ]

  const quickActions = [
    { title: "Ver Usuarios", icon: Users, color: "bg-blue-500", href: "/dashboard/admin/users" },
    { title: "Nueva Empresa", icon: Building2, color: "bg-green-500", href: "/dashboard/admin/companies" },
    { title: "Transacciones", icon: CreditCard, color: "bg-purple-500", href: "/dashboard/admin/transactions" },
    { title: "Reportes", icon: TrendingUp, color: "bg-orange-500", href: "/dashboard/admin/reports" },
    { title: "Órdenes de Compra", icon: FileText, color: "bg-indigo-500", href: "/dashboard/admin/purchase-orders" },
    { title: "Empaque", icon: Package, color: "bg-teal-500", href: "/dashboard/admin/package-route" }
  ]
