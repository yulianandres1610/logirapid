...
export default function OfficeOrdersPage() {
  ...
  // Fetch orders - ONLY OFFICE ORDERS
  ...
  const handleViewOrder = (orderId: number) => {
    window.location.href = `/dashboard/admin/office-orders/${orderId}`
  }

  // Handle edit order
  const handleEditOrder = (orderId: number) => {
    window.location.href = `/dashboard/admin/office-orders/${orderId}/edit`
  }
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-center justify-between py-6 px-4 mt-8 mb-6 bg-white dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
              ...
              <div className="flex gap-3 w-full sm:w-auto">
                ...
                <button
                  onClick={() => window.location.href = '/dashboard/admin/office-orders/create'}
                  className={cn(
