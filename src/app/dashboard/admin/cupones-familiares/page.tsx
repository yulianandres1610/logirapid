...
import {
  Send, Search, Plus, Eye, RefreshCw,
...
export default function AdminCuponesFamiliaresPage() {
  ...
  // Fetch orders (SUPER_ADMIN sees all orders)
  const fetchData = async () => {
    try {
      ...
      console.error('[Admin Cupones Familiares] Error fetching orders:', error)
  ...
  const handleViewOrder = (orderId: number) => {
    router.push(`/dashboard/admin/cupones-familiares/${orderId}`)
  }
      ...
      <DashboardLayout>
        ...
        >
          ...
          <div className="mb-2">
            ...
            )}>Cupones Familiares</h1>
            <p className={cn(
              'text-sm mt-1',
              theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
            )}>Gestión de todas las remesas de la plataforma</p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-center justify-between py-6 px-4 bg-white dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder="Buscar por orden, destinatario, remitente o empresa..."
                value={searchTerm}
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
              ...
              <div className="flex gap-3 w-full sm:w-auto">
                ...
                <button
                  onClick={() => router.push('/dashboard/admin/cupones-familiares/create')}
                  className={cn(
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                <div className="font-medium text-indigo-600 dark:text-indigo-400">
                                  {order.sellingCompanyName || 'Sin asignar'}
                                </div>
                              </div>
                            </div>
                          </td>
