...
export default function AgencyPrintServicesPage() {
  const { user } = useAuth()
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
              Configura impresoras para tu empresa: recibos POS, etiquetas de envío y más
            </p>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <ol className="text-sm text-blue-800 dark:text-blue-200 mt-2 space-y-1 list-decimal list-inside">
                <li>Crea un nuevo servicio de impresión y guarda las credenciales</li>
                <li>Descarga la aplicación LogiRapid Print Service para tu sistema operativo</li>
                <li>Instala la aplicación y configura las credenciales generadas</li>
                <li>La aplicación detectará automáticamente las impresoras conectadas</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
              Crea un servicio para comenzar a imprimir recibos y etiquetas
            </p>
              ...
              >
                ...
                <div className="flex gap-2 pt-3 border-t border-gray-100 dark:border-gray-700">
                  <Button
                    ...
                    size="sm"
                    className="flex-1"
                    onClick={() => router.push(`/dashboard/agency-admin/print-services/${service.id}`)}
                  >
                  ...
                  <Button
                    ...
                    size="sm"
                    className="flex-1"
                    onClick={() => router.push(`/dashboard/agency-admin/print-services/${service.id}/config`)}
                  >
              ...
              <form onSubmit={handleCreateService} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="ej: Impresora Oficina Principal"
                ...
                {warehouses.length > 0 && (
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Asociar a un almacén permite configurar impresoras específicas por ubicación
                    </p>
                  </div>
                )}
