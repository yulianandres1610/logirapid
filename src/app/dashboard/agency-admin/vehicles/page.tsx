...
export default function AgencyAdminVehiclesPage() {
  ...
  useEffect(() => {
    ...
    const newUrl = `/dashboard/agency-admin/vehicles${params.toString() ? '?' + params.toString() : ''}`
  ...
  const handleViewVehicle = (vehicleId: string) => {
    window.location.href = `/dashboard/agency-admin/vehicles/${vehicleId}`
  }

  // Handle edit vehicle
  const handleEditVehicle = (vehicleId: string) => {
    window.location.href = `/dashboard/agency-admin/vehicles/${vehicleId}/edit`
  }
        ...
        >
          ...
          {activeView === 'table' && (
            <div>
              ...
              <div className="flex flex-col lg:flex-row gap-6 items-center justify-between py-6 px-4 mt-8 mb-6 bg-white dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
                ...
                <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
                  ...
                  <div className="flex gap-3 w-full sm:w-auto">
                    ...
                    <button
                      onClick={() => router.push('/dashboard/agency-admin/vehicles/register')}
                      className={cn(
              ...
              {/* Vehicle List */}
              <VehicleList
                onCreateVehicle={() => router.push('/dashboard/agency-admin/vehicles/register')}
                onAssignRoute={(vehicleId) => router.push(`/dashboard/agency-admin/routes?assign=${vehicleId}`)}
