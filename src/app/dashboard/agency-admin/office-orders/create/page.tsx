...
export default function CreateAgencyOfficeOrderPage() {
  ...
  const handleCancel = () => {
    if (confirm('¿Estás seguro de cancelar? Se perderá toda la información ingresada.')) {
      router.push('/dashboard/agency-admin/office-orders')
    }
  }
      ...
      <div className={cn(
        ...
        <div className="flex justify-between items-center gap-4">
          ...
          {currentStep < steps.length ? (
            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Button
                onClick={() => router.push('/dashboard/agency-admin/office-orders')}
                className={cn(
                  "flex items-center gap-2 px-6 py-3 rounded-xl font-medium transition-all",
                  theme === 'dark'
