...
interface Stats {
  transfer: { draft: number; confirmed: number; in_progress: number; done: number; cancelled: number }
}
...
export default function TransfersPage() {
  ...
  const [stats, setStats] = useState<Stats>({ transfer: { draft: 0, confirmed: 0, in_progress: 0, done: 0, cancelled: 0 } })
  ...
  const transferStats = stats.transfer || { draft: 0, confirmed: 0, in_progress: 0, done: 0, cancelled: 0 }
  const totalTransfers = Object.values(transferStats).reduce((a, b) => a + b, 0)
  ...
  const statCards = [
    ...
    {
      title: 'Pendientes',
      value: transferStats.draft + transferStats.confirmed,
      icon: Clock,
    ...
    {
      title: 'En Proceso',
      value: transferStats.in_progress,
      icon: PlayCircle,
      gradient: 'from-purple-400 to-purple-600',
      bgGradient: theme === 'dark' ? 'from-purple-900/30 to-purple-800/20' : 'from-purple-50 to-white',
      iconBg: theme === 'dark' ? 'bg-purple-900/50' : 'bg-purple-100',
      textColor: theme === 'dark' ? 'text-purple-400' : 'text-purple-600'
    },
    {
      title: 'Completadas',
      value: transferStats.done,
      icon: CheckCircle,
          ...
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <Link href="/dashboard/market/warehouses/transfers/create">
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className={cn(
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className={cn(
                      ...
                      <motion.div
                        initial={{ width: 0 }}
                        animate={{ width: totalTransfers > 0 ? `${(stat.value / totalTransfers) * 100}%` : '0%' }}
                      ...
                      <div className="p-5">
                        <div className="flex items-start justify-between gap-4">
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            {/* Action */}
                            <Link href={`/dashboard/market/warehouses/transfers/${operation.id}`}>
                              <motion.button
                                whileHover={{ scale: 1.02 }}
                                whileTap={{ scale: 0.98 }}
                                className={cn(
