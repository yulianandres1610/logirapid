...
interface Stats {
  reception: { draft: number; confirmed: number; in_progress: number; done: number; cancelled: number }
}
...
export default function ReceptionsPage() {
  ...
  const [stats, setStats] = useState<Stats>({ reception: { draft: 0, confirmed: 0, in_progress: 0, done: 0, cancelled: 0 } })
  ...
  const receptionStats = stats.reception || { draft: 0, confirmed: 0, in_progress: 0, done: 0, cancelled: 0 }
  const totalReceptions = Object.values(receptionStats).reduce((a, b) => a + b, 0)
  ...
  const statCards = [
    ...
    {
      title: 'Pendientes',
      value: receptionStats.draft + receptionStats.confirmed,
      icon: Clock,
    ...
    {
      title: 'En Proceso',
      value: receptionStats.in_progress,
      icon: PlayCircle,
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <p className={cn(
                  ...
                  Gestiona las recepciones de mercancía
                </p>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <Link href="/dashboard/market/warehouses/receptions/create">
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className={cn(
                      ...
                      theme === 'dark'
                        ...
                        : 'bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white shadow-lg shadow-emerald-400/25'
                    )}
                  >
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className={cn(
                      ...
                      <motion.div
                        initial={{ width: 0 }}
                        animate={{ width: totalReceptions > 0 ? `${(stat.value / totalReceptions) * 100}%` : '0%' }}
            ...
            {loading ? (
              ...
              >
                ...
                <p className={cn(
                  ...
                  Crea tu primera recepción de mercancía
                </p>
                <Link href="/dashboard/market/warehouses/receptions/create">
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                      ...
                      <div className="p-5">
                        <div className="flex items-start justify-between gap-4">
                            ...
                            <div>
                              ...
                              {operation.destinationWarehouse && (
                                <div className={cn(
                                  ...
                                  <span>Destino:</span>
                                  <span className="font-medium">{operation.destinationWarehouse.name}</span>
                                </div>
                              )}
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <Link href={`/dashboard/market/warehouses/receptions/${operation.id}`}>
                              <motion.button
                                whileHover={{ scale: 1.02 }}
                                whileTap={{ scale: 0.98 }}
                                className={cn(
