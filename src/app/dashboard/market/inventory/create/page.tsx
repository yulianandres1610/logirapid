...
// Weight units - these will get special weight barcodes generated by the server
...
export default function CreateProductPage() {
  ...
  // For weight products, DON'T generate barcode - let the server generate the weight format
  const ensureBarcode = (): string => {
    if (formData.barcode && formData.barcode.trim() !== '') {
      return formData.barcode
    }
    // For weight products, leave barcode empty - server will generate weight format (20PPPPP00000C)
    if (isWeightUnit(formData.unitOfMeasure)) {
      return ''
    }
  ...
  const goToNextStep = () => {
    ...
    // BUT skip for weight products - server will generate weight barcode format
