                          ...
                          >
                            ...
                            <td className="py-4 px-4 text-right">
                              <div>
                                ...
                                <div className="text-[10px] mt-0.5 space-y-0">
                                  <p className="text-orange-600">${(product.costPrice * USD_CUP).toLocaleString('es-ES', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} CUP <span className="text-gray-400">(ElToque)</span></p>
                            ...
                            <td className="py-4 px-4 text-right">
                              <div>
                                ...
                                <div className="text-[10px] mt-0.5 space-y-0">
                                  <p className="text-green-600 font-medium">${(product.sellingPrice * USD_CUP_BCC).toLocaleString('es-ES', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} CUP <span className="text-gray-400">(BCC)</span></p>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      <div className={cn(
                        ...
                        <div className="text-xs mt-1 space-y-0.5">
                          <p className="text-blue-600">${(selectedProduct.costPrice * USD_CUP).toLocaleString('es-ES', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} CUP</p>
                      ...
                      <div className={cn(
                        ...
                        <div className="text-xs mt-1 space-y-0.5">
                          <p className="text-green-600 font-medium">${(selectedProduct.sellingPrice * USD_CUP_BCC).toLocaleString('es-ES', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} CUP <span className="text-gray-400">(BCC)</span></p>
