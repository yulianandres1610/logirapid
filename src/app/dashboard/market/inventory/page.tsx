                ...
                <div className="p-3 sm:p-6">
                  <div className="flex items-start justify-between mb-2 sm:mb-4">
                    <div className="flex items-center gap-2 sm:gap-3">
                      <div className={cn(
                        'p-2 sm:p-3 rounded-xl shadow-sm',
                        theme === 'dark'
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <select
                    ...
                    className={cn(
                      'px-4 py-2.5 rounded-xl border focus:outline-none focus:ring-2 transition-all w-full sm:w-auto sm:min-w-[180px]',
                      theme === 'dark'
                        ? 'bg-gray-800/50 border-gray-700 text-white focus:border-blue-500 focus:ring-blue-500/20'
                        : 'bg-white border-gray-200 text-gray-900 focus:border-blue-500 focus:ring-blue-500/20'
                    )}
                ...
                <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                  ...
                  {/* Spacer to push buttons to right on desktop */}
                  ...
                  <motion.button
                    ...
                    className={cn(
                      'flex items-center gap-2 px-3 sm:px-4 py-2 rounded-xl transition-all font-medium text-sm',
                      theme === 'dark'
                  ...
                  <Link href="/dashboard/market/inventory/create">
                    <motion.button
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white rounded-xl hover:from-emerald-600 hover:to-emerald-700 transition-all shadow-lg shadow-emerald-500/25 text-sm font-medium"
                    >
                            ...
                            <td className="py-3 px-2 sm:px-3 text-right hidden lg:table-cell">
                              <div>
                                <span className="text-sm text-gray-600 dark:text-gray-300">
                                  {symbol}{Number(product.costPrice).toFixed(2)}
                                </span>
                                <div className="text-[10px] mt-0.5 space-y-0 hidden lg:block">
