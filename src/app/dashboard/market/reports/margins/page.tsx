...
import { Percent, DollarSign, TrendingUp, TrendingDown, ChevronDown, ChevronRight, ChevronLeft, Package, Loader2 } from 'lucide-react'
      ...
      {data && (
        <>
          ...
          >
            {activeTab === 'products' && (
              <div>
                <h3 className="text-lg font-semibold mb-4">Margen por Producto (Costo Historico)</h3>
