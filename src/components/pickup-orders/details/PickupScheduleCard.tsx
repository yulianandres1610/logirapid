        ...
        <div className={cn(
          ...
          <div className="flex items-center justify-between">
            ...
            <span className={cn(
              ...
              status === 'picked_up' && 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400',
              status === 'reprogrammed' && 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400',
              !['pending', 'picked_up', 'reprogrammed'].includes(status) && 'bg-gray-100 text-gray-700 dark:bg-gray-900/30 dark:text-gray-400'
            )}>
              {status === 'pending' && 'Por Recoger'}
              {status === 'picked_up' && 'Recogido'}
              {status === 'reprogrammed' && 'Reprogramado'}
              {!['pending', 'picked_up', 'reprogrammed'].includes(status) && status}
            </span>
          </div>
        </div>
      </div>
