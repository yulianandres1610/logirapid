  ...
  const marketMenuItems = [
    ...
    { icon: FileText, label: "Compras", href: "/dashboard/market/purchases" },
    {
      ...
      submenuItems: [
        ...
        { icon: Factory, label: "Pintura - Órdenes", href: "/dashboard/market/production/paint/orders" },
        { icon: Timer, label: "Pintura - Piso", href: "/dashboard/market/production/paint/floor" },
    ...
    { icon: ShoppingBag, label: "Catálogo Digital", href: "/dashboard/market/settings/catalog", requiredRole: 'MARKET_MANAGER' },
