...
import com.logirapid.warehouse.kiosk.KioskDeviceAdminReceiver

class MainActivity : ReactActivity() {

    companion object {
        private const val TAG = "WarehouseMainActivity"
    }

    override fun getMainComponentName(): String = "WarehouseApp"
    ...
    private fun startKioskMode() {
        try {
            ...
            if (dpm.isDeviceOwnerApp(packageName)) {
                ...
                Log.w(TAG, "Not device owner — kiosk lock not active. Run: adb shell dpm set-device-owner com.logirapid.warehouse/.kiosk.KioskDeviceAdminReceiver")
            }
        } catch (e: Exception) {
