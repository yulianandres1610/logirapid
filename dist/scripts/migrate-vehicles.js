...
exports.migrateVehicles = migrateVehicles;
const fs_1 = require("fs");
const path_1 = require("path");
const vehicle_database_js_1 = require("../src/lib/vehicle-database.js");
    ...
    try {
        ...
        for (const vehicle of vehicles) {
            try {
                ...
                const savedVehicle = (0, vehicle_database_js_1.saveVehicleToDatabase)(vehicleData);
        ...
        console.log(`   📁 Database file: ${(0, path_1.join)(__dirname, '..', 'data', 'vehicles.json')}`);
        if (migratedCount > 0) {
