package com.logirapid.doorkiosk.datawedge
...
class DataWedgeModule(reactContext: ReactApplicationContext) :
    ...
    companion object {
        ...
        private const val PROFILE_NAME = "DoorKiosk"
        private const val ACTION_DATAWEDGE = "com.symbol.datawedge.api.ACTION"
        private const val SCAN_ACTION = "com.logirapid.doorkiosk.ACTION.SCANNER_INPUT"
    ...
    private fun registerReceiver() {
        ...
        // CRITICAL: Use RECEIVER_EXPORTED so DataWedge (external app) can send us broadcasts
    ...
    fun configureProfile() {
        ...
        // Step 2: Configure BARCODE plugin
        val barcodeConfig = Bundle().apply {
            ...
            val appConfig = Bundle().apply {
                putString("PACKAGE_NAME", "com.logirapid.doorkiosk")
        ...
        // Step 4: Disable KEYSTROKE output (eliminates keyboard issues)
